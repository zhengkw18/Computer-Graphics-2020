...
public:
    ...
    void negate();
    Vector3f confined() const;
    Vector3f fabs() const;
    double power() const;
    double max() const;
    int maxD() const;
    Vector3f getVertical() const;
    bool isZero() const;
    bool isNan() const;
    Vector3f reflect(const Vector3f& N) const;
    Vector3f rotate(const Vector3f& axis, double angle) const;
